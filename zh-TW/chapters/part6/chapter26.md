...
其中最具代表性的技術是 **VLA（視覺-語言-行動）模型**：將視覺感知、語言理解和行動決策統一到同一個大模型中——輸入「把第3號晶圓盒搬到蝕刻機EFEM的載台上」，模型直接輸出機械臂的動作序列。VLA 讓機器人的操作從「為每個任務編寫程式」走向「用自然語言指揮通用操作」[99]。

![具身智慧技術堆疊](../../images/flow_ch26_tech_stack.png)

*圖26-1：具身智慧「感知-理解-規劃-執行」技術堆疊，學習回饋閉環持續改進規劃與執行層*

![VLA(視覺-語言-行動)模型工作流程](../../images/flow_ch26_vla_pipeline.png)
...
![AMHS 天車與 AGV 智慧搬運閉環](../../images/flow_ch26_amhs_transport.png)

*圖26-3：AMHS 天車與 AGV 智慧搬運閉環——動態路徑規劃、自主異常處理與回饋閉環*
...
![潔淨室機械臂EFEM自動上下料工作流](../../images/flow_ch26_efem_workflow.png)

*圖26-4：潔淨室機械臂 EFEM 自動上下料工作流——視覺引導抓取 × Ontology 規則校驗 × 異常即停*
...
*圖26-5：具身智慧 Agent 三層架構——Ontology 認知層 × LLM/VLA 決策層 × 機器人行動層*
...
*圖26-6：晶圓廠具身智慧應用場景——智慧搬運、自動上下料與移動巡檢*
...
- **數位孿生+具身智慧**：在數位孿生環境中訓練和驗證機器人操作策略，再部署到物理設備（呼應第21章世界模型與數位孿生）[100]
