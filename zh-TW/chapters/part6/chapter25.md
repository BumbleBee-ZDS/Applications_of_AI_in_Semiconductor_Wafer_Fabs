...
![晶圓廠核心本體模型地圖](../../images/flow_ch25_ontology_map.png)

*圖25-1：晶圓廠核心本體模型地圖——產品/製程/設備/缺陷/時間五大本體與關係鏈路*
...
![本體驅動的資料融合架構](../../images/flow_ch25_data_fusion.png)

*圖25-2：本體驅動的資料融合——MES、FDC、SPC、YMS 經語義對齊映射到統一本體*
...
![晶圓廠本體實施四階段路徑](../../images/flow_ch25_build_roadmap.png)

*圖25-3：晶圓廠本體實施四階段路徑——增量式構建，從最高價值場景出發*
