...
> **本书数据**：28 章 · 3 种语言 · 20+ Demo 脚本 · 22 个动手实验 · 47 张配图 · 100+ 产业案例引用
...
第七部分  动手实验实验室
└── 第 27 章 动手实验实验室——把关键概念跑起来（22 个可运行实验）
...
22 个可运行的完整实验项目位于根目录 `experiments/`（三语共用），详见第27章。以依赖最轻的 Ontology Text2SQL 为例：
...
- **扩展至27章**——新增第27章动手实验实验室，配套 22 个可运行实验项目（LLM/Agent/良率/调度/专家系统等）
