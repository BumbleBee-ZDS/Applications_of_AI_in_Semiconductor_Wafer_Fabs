...
> **Chapter experiment**: Experiment 20 in Chapter 27 (`demos/experiments/agent_task_decomposition`) decomposes a high-level goal into executable subtasks and executes them — a direct demo of this chapter's "symbolic planning for direction, action execution for landing" (SA fusion).
