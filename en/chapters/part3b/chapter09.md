...
> **Chapter experiment**: Experiment 10 in Chapter 27 (`demos/experiments/yield_modeling_ramp`) reproduces the Poisson/Negative-Binomial yield models and the S-shaped ramp curve in code, plus a starter virtual metrology example — run it to verify this chapter's conclusions.
